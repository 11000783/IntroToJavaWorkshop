...
int backround = -1;
	...
	private void scare() {
		System.out.println("clown 4.jpeg");
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("crep.mp3"));
		sound.play();
